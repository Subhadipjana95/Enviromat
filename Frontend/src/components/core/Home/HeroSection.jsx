...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen overflow-hidden">
      <div className="max-w-full mx-auto sm:px-5 lg:pl-8 py-2 lg:py-6">
          ...
          <div className="flex flex-col justify-end h-[90%] w-full">
            ...
            <div className="title flex flex-col gap-4 mb-[60px]">
              ...
              <div className="space-y-1">
                ...
                <h1 ref={headingRef} className="text-6xl lg:text-7xl font-light text-gray-900 leading-tighter transform-gpu">
                  Leading the Way
                  <br />
            ...
            <div className="w-[105%] flex justify-between items-end">
              ...
              <div className="flex space-x-4 pt-8">
                <div 
                  ...
                  className="w-25 h-30 bg-gray-300 rounded-xl overflow-hidden transform-gpu hover:shadow-lg transition-shadow duration-300"
                >
                  <img
                ...
                <div 
                  ...
                  className="w-25 h-30 bg-green-200 rounded-xl overflow-hidden transform-gpu hover:shadow-lg transition-shadow duration-300"
                >
                  <img
