            ...
            {isAuthenticated ? (
              ...
              <>
                <motion.button
                  ...
                  className="bg-[#F9FAFB] backdrop-blur-xl px-4 py-2 border border-gray-300 rounded-full text-sm font-medium text-gray-600 hover:text-gray-700 hover:border-gray-400 transition-colors transform-gpu"
                >
                  Sign Up
                </motion.button>
                <motion.button
